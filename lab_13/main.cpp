...
public:
	...
	void insert(HashTableItem* item) {
		...
		size_t index = item->hash() % m_length;
...
int main() {
	...
	hashTable.insert(new HashTableItem("Hash"));
	hashTable.insert(new HashTableItem("Hello"));
	hashTable.insert(new HashTableItem("World"));
	hashTable.insert(new HashTableItem("Table"));
	hashTable.insert(new HashTableItem("World"));
